...
namespace EL
{
    public class EPosition
    {
        ...
        private decimal _Multi1MA;
        private decimal _Multi1MO;
        private decimal _Multi2MA;
        private decimal _Multi2MO;
        private decimal _Multi3MA;
        private decimal _Multi3MO;
        private decimal _Multi4MA;
        private decimal _Multi4MO;
        private decimal _Multi5MA;
        private decimal _Multi5MO;
        private decimal _EinkaufspreisMA;
        private decimal _EinkaufspreisMO;
        private decimal _SelbstkostenMultiMA;
        private decimal _SelbstkostenMultiMO;
        private decimal _SelbstkostenValueMA;
        private decimal _SelbstkostenValueMO;
        private decimal _VerkaufspreisMultiMA;
        private decimal _VerkaufspreisMultiME;
